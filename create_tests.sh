...
# Run the tests
faketime "Nov 13" ./spacecheck.sh "./unit_tests" > "./expected_output/full.out"
test_passed "General 1"
faketime "Nov 13" ./spacecheck.sh -r "./unit_tests" > "./expected_output/full_reversed.out"
test_passed "General 2"
faketime "Nov 13" ./spacecheck.sh -a "./unit_tests" > "./expected_output/full_alphabetical.out"
...
test_passed "Regex 1"
faketime "Nov 13" ./spacecheck.sh -n ".*abc" "./unit_tests/regex_tests" > "./expected_output/regex_tests/2.out"
test_passed "Regex 2"
faketime "Nov 13" ./spacecheck.sh -n ".*a.b.*" "./unit_tests/regex_tests" > "./expected_output/regex_tests/3.out"
test_passed "Regex 3"
faketime "Nov 13" ./spacecheck.sh -n ".*a+.*" "./unit_tests/regex_tests" > "./expected_output/regex_tests/4.out"
test_passed "Regex 4"
faketime "Nov 13" ./spacecheck.sh -n "[abc]" "./unit_tests/regex_tests" > "./expected_output/regex_tests/5.out"
test_passed "Regex 5"
faketime "Nov 13" ./spacecheck.sh -n "[^abc]" "./unit_tests/regex_tests" > "./expected_output/regex_tests/6.out"
test_passed "Regex 6"
faketime "Nov 13" ./spacecheck.sh -n "[a-z]" "./unit_tests/regex_tests" > "./expected_output/regex_tests/7.out"
test_passed "Regex 7"
faketime "Nov 13" ./spacecheck.sh -n "[A-Z]" "./unit_tests/regex_tests" > "./expected_output/regex_tests/8.out"
test_passed "Regex 8"
faketime "Nov 13" ./spacecheck.sh -n "[0-9]" "./unit_tests/regex_tests" > "./expected_output/regex_tests/9.out"
test_passed "Regex 9"

# Size Tests
faketime "Nov 13" ./spacecheck.sh -s "10" "./unit_tests/size_tests" > "./expected_output/size_tests/1.out"
test_passed "Size 1"
faketime "Nov 13" ./spacecheck.sh -s "100" "./unit_tests/size_tests" > "./expected_output/size_tests/2.out"
test_passed "Size 2"
faketime "Nov 13" ./spacecheck.sh -s "200" "./unit_tests/size_tests" > "./expected_output/size_tests/3.out"
test_passed "Size 3"
faketime "Nov 13" ./spacecheck.sh -s "300" "./unit_tests/size_tests" > "./expected_output/size_tests/4.out"
test_passed "Size 4"

# Date Tests
faketime "Nov 13" ./spacecheck.sh -d "n" "./unit_tests/date_tests" > "./expected_output/date_tests/1.out"
test_passed "Date 1"
faketime "Nov 13" ./spacecheck.sh -d "Nov 1" "./unit_tests/date_tests" > "./expected_output/date_tests/2.out"
test_passed "Date 2"
faketime "Nov 13" ./spacecheck.sh -d "01/10/2023" "./unit_tests/date_tests" > "./expected_output/date_tests/3.out"
test_passed "Date 3"
faketime "Nov 13" ./spacecheck.sh -d "2023/8/01" "./unit_tests/date_tests" > "./expected_output/date_tests/4.out"
test_passed "Date 4"

# Forced Errors
faketime "Nov 13" ./spacecheck.sh -d "./unit_tests/date_tests" > "./expected_output/errors/1.out"
test_passed "Error 1"
faketime "Nov 13" ./spacecheck.sh -d "asdas" "./unit_tests/date_tests" > "./expected_output/errors/2.out"
test_passed "Error 2"
faketime "Nov 13" ./spacecheck.sh -s "./unit_tests/date_tests" > "./expected_output/errors/3.out"
test_passed "Error 3"
faketime "Nov 13" ./spacecheck.sh -s "aa" "./unit_tests/date_tests" > "./expected_output/errors/4.out"
test_passed "Error 4"
faketime "Nov 13" ./spacecheck.sh -n "./unit_tests/date_tests" > "./expected_output/errors/5.out"
test_passed "Error 5"
